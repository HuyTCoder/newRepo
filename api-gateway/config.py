AUTH_SERVICE_SECRET = 'django-insecure-4a&x1!*-y6$vglx$z4b$fs&+etngop*m%r2s*mfj#q+q5=qw!-'
SERVICES = {
    "svc-auth": "http://service-auth:8001",
    "svc-doctor": "http://service-doctor:8002",
    "svc-appointment": "http://service-appointment:8003",
